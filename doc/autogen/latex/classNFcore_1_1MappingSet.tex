...
\item 
bool {\bf hasSpeciesDeletionTransform} () const 
\item 
unsigned int {\bf getId} () const 
\item 
unsigned int {\bf getNumOfMappings} () const 
\item 
...
\item[Author:]Michael Sneddon \end{Desc}
\index{NFcore::MappingSet@{NFcore::MappingSet}!getPopulation@{getPopulation}}
\index{getPopulation@{getPopulation}!NFcore::MappingSet@{NFcore::MappingSet}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int MappingSet::getPopulation () const}\label{classNFcore_1_1MappingSet_d97b13ab5c1eb87ab5c36e9c7eb7ba6a}


Gets the population \begin{Desc}
\item[Author:]JustinHogg \end{Desc}
\index{NFcore::MappingSet@{NFcore::MappingSet}!hasSpeciesDeletionTransform@{hasSpeciesDeletionTransform}}
\index{hasSpeciesDeletionTransform@{hasSpeciesDeletionTransform}!NFcore::MappingSet@{NFcore::MappingSet}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}bool NFcore::MappingSet::hasSpeciesDeletionTransform () const\hspace{0.3cm}{\tt  [inline]}}\label{classNFcore_1_1MappingSet_28c18be20c69806af4e027f188f31c3e}


We only have to know if this is a species deletion- molecule deletions are handled automatically within the rest of the framework. \index{NFcore::MappingSet@{NFcore::MappingSet}!getId@{getId}}
...
\item[Author:]Michael Sneddon \end{Desc}
\index{NFcore::MappingSet@{NFcore::MappingSet}!getNumOfMappings@{getNumOfMappings}}
\index{getNumOfMappings@{getNumOfMappings}!NFcore::MappingSet@{NFcore::MappingSet}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}unsigned int NFcore::MappingSet::getNumOfMappings () const\hspace{0.3cm}{\tt  [inline]}}\label{classNFcore_1_1MappingSet_e41a3c4cf3c73420ea5d20a647b843b8}
...
\index{NFcore::MappingSet@{NFcore::MappingSet}!getComplexID@{getComplexID}}
\index{getComplexID@{getComplexID}!NFcore::MappingSet@{NFcore::MappingSet}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int MappingSet::getComplexID () const}\label{classNFcore_1_1MappingSet_4fb94e6a8a9012cc8989b31db15650d5}
...
An array of pointers to \doxyref{Mapping}{p.}{classNFcore_1_1Mapping} objects. This is where the actual Mappings are stored. \index{NFcore::MappingSet@{NFcore::MappingSet}!isSpeciesDeletion@{isSpeciesDeletion}}
\index{isSpeciesDeletion@{isSpeciesDeletion}!NFcore::MappingSet@{NFcore::MappingSet}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}bool {\bf NFcore::MappingSet::isSpeciesDeletion}\hspace{0.3cm}{\tt  [protected]}}\label{classNFcore_1_1MappingSet_de44dc089f7759e39fe165bb04e15ab3}
