...
\item 
{\bf DORRxnClass} (string {\bf name}, double {\bf baseRate}, {\bf TransformationSet} $\ast${\bf transformationSet}, {\bf CompositeFunction} $\ast$function, vector$<$ string $>$ \&lfArgumentPointerNameList, {\bf System} $\ast$s)
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}DORRxnClass::DORRxnClass (string {\em name}, double {\em baseRate}, {\bf TransformationSet} $\ast$ {\em transformationSet}, {\bf CompositeFunction} $\ast$ {\em function}, vector$<$ string $>$ \& {\em lfArgumentPointerNameList}, {\bf System} $\ast$ {\em s})}\label{classNFcore_1_1DORRxnClass_b75bd1a970da879e60811fec0d4db137}
