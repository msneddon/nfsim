...
namespace NFcore {
	...
	/*!
	    ...
	    <table border=0>
	    	<tr><td><u>name</u>&nbsp&nbsp</td><td><u>n_args</u>&nbsp&nbsp</td><td><u>description</u></td></tr>
	    ...
	    <table border=0>
	    	<tr><td><u>name&nbsp&nbsp</u></td><td><u>value</u>&nbsp&nbsp</td><td><u>description</u></td></tr>
	...
	class FuncFactory {
		public:
			...
			*/
			...
			static const double NA = 6.02214179e23;
		...
		public:
			...
			*/
			...
			/*!
				...
				arguements.  It is publicly visible, so be careful with it!  Use this variable to evaluate the function.
