...
bool TransformationSet::transform(MappingSet **mappingSets)
{
	...
	/*
	// NOTE: I think this check should occur before we remove molecules from observables. Currently I
	//  have a similar check as part of the method "checkMolecularity".  --Justin

	// loop over reactants and decide if this reaction has any null conditions
	for(unsigned int r=0; r<getNreactants(); r++)
	{
...
void TransformationSet::finalize()
{
	...
	//   possibility of reactant center overlap: are there a common molecule type in
