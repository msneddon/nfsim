...
#include "netgen_test.hh"




void netgen_test::run()
{
	cout<<"Generating network for the simple system"<<endl;
	...
	System *s = new System("Simple System", useComplex);
	...
	s->registerOutputFileLocation("netgen_test_output.txt");
	s->outputAllObservableNames();


    //  8) create a netgen object loaded with system
    Netgen * ng = new Netgen ( s );
...
MoleculeType * netgen_test::createX(System *s)
{
...
MoleculeType * netgen_test::createY(System *s)
{
...
ReactionClass * netgen_test::createReactionXDephos(MoleculeType *molX, double rate)
{
...
ReactionClass * netgen_test::createReactionXYbind(MoleculeType *molX,MoleculeType *molY, double rate)
{
...
ReactionClass * netgen_test::createReactionXYunbind(MoleculeType *molX, MoleculeType *molY, double rate)
{
...
ReactionClass * netgen_test::createReactionYphosX(MoleculeType *molX, MoleculeType *molY, double rate)
{
...
void netgen_test::addObs(System * s, MoleculeType *molX, MoleculeType *molY)
{
