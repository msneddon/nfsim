...
\item 
static {\bf Transformation} $\ast$ {\bf genNewMoleculeBindingTransform1} (unsigned int bSiteIndex, unsigned int otherReactantIndex, unsigned int otherMappingIndex)
\item 
...
\item[Author:]Michael Sneddon \end{Desc}
\index{NFcore::TransformationFactory@{NFcore::TransformationFactory}!genNewMoleculeBindingTransform1@{genNewMoleculeBindingTransform1}}
\index{genNewMoleculeBindingTransform1@{genNewMoleculeBindingTransform1}!NFcore::TransformationFactory@{NFcore::TransformationFactory}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf NFcore::Transformation} $\ast$ TransformationFactory::genNewMoleculeBindingTransform1 (unsigned int {\em bSiteIndex}, unsigned int {\em otherReactantIndex}, unsigned int {\em otherMappingIndex})\hspace{0.3cm}{\tt  [static]}}\label{classNFcore_1_1TransformationFactory_e0662a0c03ff370d74ac8dd4fe7d48ef}


Generates a binding transformation for one of the two binding sites in the binding Transform, where at least one of the molecules is a newly created object, so that null condition checks are omitted. You will still have to tell it where the other \doxyref{Transformation}{p.}{classNFcore_1_1Transformation} object lives (\doxyref{TransformationSet}{p.}{classNFcore_1_1TransformationSet} has this information). \begin{Desc}
\item[Author:]Michael Sneddon \end{Desc}
