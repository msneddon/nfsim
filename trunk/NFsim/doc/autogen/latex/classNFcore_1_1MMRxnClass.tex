...
\item 
{\bf MMRxnClass} (string {\bf name}, double {\bf kcat}, double {\bf Km}, {\bf TransformationSet} $\ast${\bf transformationSet}, {\bf System} $\ast$s)
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}MMRxnClass::MMRxnClass (string {\em name}, double {\em kcat}, double {\em Km}, {\bf TransformationSet} $\ast$ {\em transformationSet}, {\bf System} $\ast$ {\em s})}\label{classNFcore_1_1MMRxnClass_02d8ca3e9e4efda106c662afa7dbdfdd}
